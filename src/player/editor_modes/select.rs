...
use crate::{newtypes::coordinate::Coordinate, player::mouse_interaction::OnMousePressed, world::WorldSettings};
...
impl Plugin for SelectModePlugin {
    fn build(&self, app: &mut App) {
        app.init_resource::<CurrentSelection>()
            .add_systems(Update, (handle_input, draw_current_selection).run_if(in_state(EditorMode::Select)));
    }
}
